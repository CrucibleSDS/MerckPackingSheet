...
\item{% if "ASPIRATIONAL_HAZARD" in data.hazard_statement_overview %}[\done]{% endif %} Aspirational Hazard
\item{% if "CARCINOGENCITY" in data.hazard_statement_overview %}[\done]{% endif %} Carcinogencity
...
\item{% if "GERM_CELL_MUTAGENCITY" in data.hazard_statement_overview %}[\done]{% endif %} Germ Cell Mutagencity
